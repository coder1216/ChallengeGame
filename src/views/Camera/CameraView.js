...
sendNotification(){
  ...
  return fetch(url,{
    ...
    body: JSON.stringify({
      username: [this.props.navigation.state.params.CompetitorUserName],     //array
      // description: this.state.description,    //string
      description: this.props.navigation.state.params.CompetitorNickName + ", your opponent "+ this.props.navigation.state.params.myNickName + " is doing challenge now!",
    })
  })
  ...
  pullPost(){
    ...
    return fetch(url,{
      ...
      body: JSON.stringify({
        ...
        username: this.props.navigation.state.params.userUserName,
        img: this.state.image64,
        date: this.showTempDate(),
        isChallenge: "true",
        time: this.showTempTime(),
